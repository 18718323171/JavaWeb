...
<body>
	<%
		...
		String stu_SubTime = ((Object) student.SubTime).toString();
		String pageNum = ""; //试卷编号
		String subject = ""; //科目
		String exam_SubTime ="";
		...
		int totalScore = 0; //总分
		int examTime = 0; //考试时间
		ArrayList<ExamInfo> ExamArr = (ArrayList<ExamInfo>) request.getAttribute("ExamArr");
	%>
	<!--背景图片开始-->
	<div>
	...
	<div class="main">
		...
		<span class="main-left" id="div_left"> <!--左栏内容开始-->
			<div class="left-style text">
				<a href="#" onclick="hiddenOp('userInfo')">学生信息</a>
			</div>
			<div class="left-style text">
				<a href="javascript:void(0)" onclick="hiddenOp('studentExam')">学生考试</a>
			</div>
			<div class="left-style text">
				<a href="javascript:void(0)" onclick="hiddenOp('queryScore')">成绩查询</a>
			</div>
			<div class="left-style text">
				<a href="javascript:void(0)" id="b01" onclick="hiddenOp('updatePwd')">修改密码</a>
			</div> <!--左栏内容结束-->
		</span>
		<!--左栏框结束-->
		<!--右栏框开始-->
		<span class="main-right" id="main_content_right" id="div_right">
			...
			<div class="right-style" id="userInfo">
				...
				<div class="right-info-style">
					<span>学号：<input type="text" id="txtNum" readonly="readonly"
						value="<%=stuNum%>" style="border: none;"></span>
				</div>
				<div class="right-info-style">
					<span>姓名：<input type="text" id="txtName" readonly="readonly"
						value="<%=stuName%>" style="border: none;"></span>
				</div>
				<div class="right-info-style">
					<span>性别：<input type="text" id="txtGender"
						readonly="readonly" value="<%=gender%>" style="border: none;"></span>
				</div>
				<div class="right-info-style">
					<span>身份证：<input type="text" id="txtIdCard"
						readonly="readonly" value="<%=idCard%>" style="border: none;"></span>
				</div>
				...
				<div class="right-info-style">
					<span>最近登录时间：<input type="text" id="txtTime"
						readonly="readonly" value="<%=stu_SubTime%>" style="border: none;"></span>
				</div>
				<div style="text-align: center; margin-top: 6%;">
					<input type="button" style="width: 20%;" value="修改"
						onclick="update()"><input type="button"
						style="width: 20%;" value="取消" onclick="updateCancel()">
				</div>
			</div> <!--用户信息结束--> 
			<!--学生考试开始-->
			<div class="right-style" id="studentExam" style="display: none;">
				<h2 style="text-align: center;">考试安排</h2>
				<hr style="border: solid 1px #666666">
				<%
					for (int i = 0; i < ExamArr.size(); i++) {
						...
						subject = e.Subject;
						pageType = e.PageType;
						startTime = ((Object)e.StartTime).toString();
						endTime = ((Object)e.EndTime).toString();
						exam_SubTime = ((Object)e.SubTime).toString();
				...
				%>
				<!-- 未考科目 -->
				<div class="right-info-style" style="height: 40%;border-bottom:none;">
					<div style="border: none;height:20%;">考试科目：<%= subject%>&nbsp;&nbsp;考试时间：<%= startTime %>&nbsp;&nbsp;过期时间：<%= endTime%>
					<input type="button" style="float:right;" value="我要考试" onclick="getPageInfo()" /></div>
					<div style="border: none;height:20%;">考试科目：<%= subject%>&nbsp;&nbsp;考试时间：<%= startTime %>&nbsp;&nbsp;过期时间：<%= endTime%>
					<input type="button" style="float:right;" value="我要考试" onclick="getPageInfo()" /></div>
					<div style="border: none;height:20%;">考试科目：<%= subject%>&nbsp;&nbsp;考试时间：<%= startTime %>&nbsp;&nbsp;过期时间：<%= endTime%>
					<input type="button" style="float:right;" value="我要考试" onclick="getPageInfo()" /></div>
			...
			<!-- 成绩查询开始 -->
			<div class="right-style" id="queryScore" style="display: none;">
			...
			<div class="right-style" id="updatePwd" style="display: none;">
				...
				<div style="height: 60%; padding-top: 5%;">
					<div class="right-pwd-style">
						旧密码：<input class="right-pwd-txtStyle pwd" type="text">
					</div>
					<div class="right-pwd-style">
						新密码：<input class="right-pwd-txtStyle pwd" type="text">
					</div>
					<div class="right-pwd-style">
						确认密码：<input class="right-pwd-txtStyle pwd" type="text">
					</div>
					<div class="right-pwd-style">
						<input type="button" style="width: 20%;" value="修改">&nbsp;&nbsp;&nbsp;&nbsp;<input
							type="reset" style="width: 20%;" value="重置">
					</div>
				</div>
	...
	<!--底栏开始-->
		...
		<!--底栏结束-->
	<input type="hidden" id="LinkPage"
		value="ExamController?a=getPageInfo&pageNum=<%=pageNum%>
